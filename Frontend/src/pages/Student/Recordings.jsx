          ...
          {courses.map((course) => (
            ...
            >
              <div className="p-6 flex-1">
                ...
                {course.description && (
                  <p className="text-sm text-gray-600 mt-2 line-clamp-3" style={{ whiteSpace: 'pre-line', fontWeight: 'normal' }} dangerouslySetInnerHTML={{ __html: course.description?.replace(/\*\*(.*?)\*\*/g, '<strong class="font-bold text-lg">$1</strong>') || '' }} />
                )}
