...
const ResourceRecordManagement = () => {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      if (editingId) {
        await api.put(`/courses/${selectedCourse}/resourcesrecord/${editingId}`, form);
        window.location.reload();
        showToast("Resource updated successfully", "success");
      } else {
        await api.post(`/courses/${selectedCourse}/resourcesrecord`, form);
        window.location.reload();
  ...
  const handleDelete = useCallback(async (id) => {
    ...
    setFormLoading(true);
    try {
      await api.delete(`/courses/${selectedCourse}/resourcesrecord/${id}`);
      window.location.reload();
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Manage Recordings Resources</h1>
...
export default ResourceRecordManagement;