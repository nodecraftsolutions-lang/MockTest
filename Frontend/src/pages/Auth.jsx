  ...
  const updateRedirectMessage = () => {
    ...
    if (redirectUrl && !cameFromNavbar) {
      ...
      if (redirectUrl.includes('/student/courses/')) {
        ...
        setRedirectMessage('Sign up or log in to PREPZON to test your skills with our mock exams-designed to match real Exam patterns and boost your confidence.');
      } else {
