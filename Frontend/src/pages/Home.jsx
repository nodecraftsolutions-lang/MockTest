        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <div className="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-xl p-8 max-w-2xl mx-auto">
                <GraduationCap className="w-12 h-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-foreground mb-2">No Alumni Testimonials Yet</h3>
                <p className="text-muted-foreground mb-4">
                  We're working on collecting testimonials from our successful students. Check back soon!
                </p>
              </div>
            </div>
          )}
